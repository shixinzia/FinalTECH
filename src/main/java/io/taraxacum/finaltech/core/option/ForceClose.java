...
public final class ForceClose {
    ...
    public static final ItemStack FALSE_ICON = new CustomItemStack(Material.RED_STAINED_GLASS_PANE, FinalTech.getLanguageString("option", "FORCE_CLOSE", "false", "name"), FinalTech.getLanguageStringArray("option", "FORCE_CLOSE", "false", "lore"));
    public static final ItemStack TRUE_ICON = new CustomItemStack(Material.GREEN_STAINED_GLASS_PANE, FinalTech.getLanguageString("option", "FORCE_CLOSE", "true", "name"), FinalTech.getLanguageStringArray("option", "FORCE_CLOSE", "true", "lore"));
