 ...
 * @author Final_ROOT
 */
public class ItemDeserializeParserInventory extends AbstractOrdinaryMachineInventory {
    private final int[] border = new int[] {45, 46, 47, 51, 52, 53};
    private final int[] inputBorder = new int[] {48, 50};
    private final int[] outputBorder = new int[] {36, 37, 38, 39, 40, 41, 42, 43, 44};
    private final int[] inputSlot = new int[] {49};
    ...
    public ItemDeserializeParserInventory(@Nonnull AbstractMachine abstractMachine) {
