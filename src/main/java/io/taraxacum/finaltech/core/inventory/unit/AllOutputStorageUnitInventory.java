 ...
 * @author Final_ROOT
 */
public class AllOutputStorageUnitInventory extends AbstractOrdinaryMachineInventory {
    ...
    public AllOutputStorageUnitInventory(@Nonnull AbstractMachine machine) {
        super(machine);
    }
