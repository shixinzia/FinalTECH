 ...
 * @author Final_ROOT
 */
public class RandomOutputStorageUnitInventory extends AbstractOrdinaryMachineInventory {
    ...
    public RandomOutputStorageUnitInventory(@Nonnull AbstractMachine machine) {
        super(machine);
    }
    ...
    public int[] requestSlots(@Nonnull RequestType requestType) {
        return switch (requestType) {
            ...
            case OUTPUT -> JavaUtil.shuffle(this.getOutputSlot());
            default -> new int[0];
        };
    }
