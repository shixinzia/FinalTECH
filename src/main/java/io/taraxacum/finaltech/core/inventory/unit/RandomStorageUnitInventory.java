 ...
 * @author Final_ROOT
 */
public class RandomStorageUnitInventory extends AbstractOrdinaryMachineInventory {
    ...
    public RandomStorageUnitInventory(@Nonnull AbstractMachine machine) {
        super(machine);
    }
    ...
    public int[] requestSlots(@Nonnull RequestType requestType) {
        return JavaUtil.shuffle(super.requestSlots(requestType));
    }
