 ...
 * @author Final_ROOT
 */
public class NormalTriggerableElectricityShootPile extends AbstractDigitElectricityShootPile {

    public NormalTriggerableElectricityShootPile(@Nonnull ItemGroup itemGroup, @Nonnull SlimefunItemStack item) {
