 ...
 * @author Final_ROOT
 */
public class Shell extends UnusableSlimefunItem implements RecipeItem, SimpleValidItem, UnCopiableItem {
    private final ItemWrapper templateValidItem;

    public Shell(@Nonnull ItemGroup itemGroup, @Nonnull SlimefunItemStack item, @Nonnull RecipeType recipeType) {
