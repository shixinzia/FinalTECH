 ...
 * @author Final_ROOT
 */
public class Singularity extends UnusableSlimefunItem implements RecipeItem, SimpleValidItem, UnCopiableItem {
    private final ItemWrapper templateValidItem;

    public Singularity(@Nonnull ItemGroup itemGroup, @Nonnull SlimefunItemStack item, @Nonnull RecipeType recipeType) {
