 ...
 * @author Final_ROOT
 */
public class AdvanceIngotPulverizer extends AbstractAdvanceMachine {
    public AdvanceIngotPulverizer(@Nonnull ItemGroup itemGroup, @Nonnull SlimefunItemStack item) {
