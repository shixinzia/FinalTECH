 ...
 * @author Final_ROOT
 */
public class StorageExporter extends StorageOperator implements RecipeItem {

    public StorageExporter(@Nonnull ItemGroup itemGroup, @Nonnull SlimefunItemStack item) {
    ...
    protected void tick(@Nonnull Block block, @Nonnull SlimefunItem slimefunItem, @Nonnull LocationData locationData) {
        ...
        Runnable runnable = () -> {
            ...
            abstractStorageMachine.output(itemMap, targetLocationData, itemString, inventory, this.getOutputSlot());
