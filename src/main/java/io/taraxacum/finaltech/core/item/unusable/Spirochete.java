 ...
 * @author Final_ROOT
 */
public class Spirochete extends UnusableSlimefunItem implements RecipeItem, SimpleValidItem, UnCopiableItem {
    private final ItemWrapper templateValidItem;

    public Spirochete(@Nonnull ItemGroup itemGroup, @Nonnull SlimefunItemStack item, @Nonnull RecipeType recipeType) {
